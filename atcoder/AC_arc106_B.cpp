...
//   Address :   https://atcoder.jp/contests/arc106/tasks/arc106_b
//   Date    :   2020/10/24
// =====================================================
...
void dfs(int p, int u, vi& nodes, vb& visited, vvi& edges) {
    visited[u] = true;
    nodes.pb(u);
    for(auto &v:edges[u]) if (v != p && !visited[v])
        dfs(u, v, nodes, visited, edges);
}
